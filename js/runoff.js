      ...
      div class=row g-4 fade-in
        div class=col-lg-6
          div class=glass-card p-4 h-100
            h5 class=card-title-custom mb-3 fs-6i class=bi bi-shuffle text-brandi Matriz de Migração de Votosh5
            div class=row g-2 mb-3
              div class=col-6
                label class=small text-mutedFinalista 1label
              ...
              div
              div class=col-6
                label class=small text-mutedFinalista 2label
            ...
            div class=p-3 bg-dark-surface rounded border border-secondary mb-3
              div class=d-flex justify-content-between small mb-1
                span class=text-white fw-boldEleitores de Clarice Silveira (AD)span
            ...
            div class=p-3 bg-dark-surface rounded border border-secondary
              div class=d-flex justify-content-between small mb-1
                span class=text-white fw-boldEleitores de Rodrigo Tavares (MC)span
        ...
        div class=col-lg-6
          div class=glass-card p-4 h-100 text-center d-flex flex-column justify-content-between
            div
              span class=badge bg-primary text-uppercase px-3 py-1 mb-2Projeção de Votos Válidosspan
              h4 class=text-white mb-3Segundo Turno Simuladoh4
            ...
            div class=p-3 bg-dark rounded border border-success text-start
              strong class=text-successi class=bi bi-trophy-fill me-1i Vencedor Estimadostrong
